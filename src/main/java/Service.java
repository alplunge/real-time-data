...
public class Service {
    ...
    Map home(Service s) {
        ...
        HashMap availableData = new HashMap<>();
        availableData.put("pulsometer", s.pulsometer.get(passedSeconds));
        availableData.put("r", s.r.get(passedSeconds));
        availableData.put("g", s.g.get(passedSeconds));
        availableData.put("b", s.b.get(passedSeconds));
        availableData.put("EngineEff", decimalFormat.format(s.EngineEff.get(passedSeconds)));
